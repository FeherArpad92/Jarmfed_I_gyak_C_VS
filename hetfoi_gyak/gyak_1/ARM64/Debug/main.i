#line 1 "Y:\\Jarmfed_I_gyak_C_VS\\hetfoi_gyak\\gyak_1\\main.c"
...
#line 483 "C:\\Program Files (x86)\\Windows Kits\\10\\Include\\10.0.22621.0\\ucrt\\corecrt_wstdio.h"
    {
        int _Result;
        va_list _ArgList;
        ((void)(__va_start(&_ArgList, (&(_Locale)), ((sizeof(_Locale) + 8 - 1) & ~(8 - 1)), __alignof(_Locale), (&(_Locale)))));
...
#line 501 "C:\\Program Files (x86)\\Windows Kits\\10\\Include\\10.0.22621.0\\ucrt\\corecrt_wstdio.h"
    {
        int _Result;
        va_list _ArgList;
        ((void)(__va_start(&_ArgList, (&(_Format)), ((sizeof(_Format) + 8 - 1) & ~(8 - 1)), __alignof(_Format), (&(_Format)))));
...
#pragma external_header(pop)
#line 9 "Y:\\Jarmfed_I_gyak_C_VS\\hetfoi_gyak\\gyak_1\\main.c"
